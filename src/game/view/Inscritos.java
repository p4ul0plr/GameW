 ...
 * @author UNIVASF
 */
public class Inscritos extends javax.swing.JDialog {

    /**
     * Creates new form Inscritos
     */
    public Inscritos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inscritos dialog = new Inscritos(new javax.swing.JFrame(), true);
